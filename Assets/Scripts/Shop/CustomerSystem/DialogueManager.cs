...
public class DialogueManager : MonoBehaviour
{
    ...
    {
        // replace with localization key later 
        _text.text = text;
    ...
    public void RefreshDialogueHandles()
    {
        ...
        {
            var optionObj = _dialogueOptionActive[_dialogueOptions.IndexOf(option)]
            ...
            optionObj.GetComponent<DialogueOptionHandle>()
                .Setup(GetComponent<CustomerManager>().CurrentCustomer, option);
        }
    }
