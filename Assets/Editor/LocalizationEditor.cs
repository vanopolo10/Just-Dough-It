...
public class LocalizationEditor : Editor
{
    ...
    // лениво создаём стиль, когда он реально нужен
    private void EnsureStyles()
    {
        ...
        // поэтому подстрахуемся и возьмём GUI.skin.textArea как запасной вариант.
    ...
    public override void OnInspectorGUI()
    {
        ...
        EnsureStyles(); // гарантируем, что стиль создан к моменту рисования GUI
        ...
        for (int row = 0; row < maxRows; row++)
        {
            ...
            foreach (var table in _manager.Tables)
            {
                ...
                if (newValue != currentValue)
                {
                    ...
                    table.Keys[row].Value = newValue; // переносы строк сохраняются
                    EditorUtility.SetDirty(_manager);
                }
            }
